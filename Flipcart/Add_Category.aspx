<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Add_Category.aspx.cs" Inherits="Flipcart.Add_Category" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="w-100">
        ...
        <tr>
            <td class="auto-style1">
            <asp:Label ID="Label5" runat="server" Font-Bold="True" ForeColor="Black" Text="Status"></asp:Label>
            </td>
            <td class="auto-style2">
